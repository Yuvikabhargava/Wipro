...
namespace GenericINterface
{
    internal class Hotel : IRoom<RoomAC>, IRoom<RoomNonAC>
    {
        ...
        {
            new (){RoomNo=111,RoomType="Single",Price=5000},
            new (){RoomNo=113,RoomType="Single",Price=5000},
            new (){RoomNo=112,RoomType="Double",Price=8000},
            new (){RoomNo=114,RoomType="Single",Price=5000},
